...
Tutorial : [https://youtu.be/SDtWLz4Itg0](https://youtu.be/SDtWLz4Itg0)
...
- Ajoutez un fichier `package.json` dans le dossier cloné
...
Pusher le git de "Notre projet" sur GitHub avec Github Desktop:
