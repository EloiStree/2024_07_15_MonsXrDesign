...
Video: [Part 5, Créer un beau cube à partager ses amis sur Unity3D](https://youtu.be/SDtWLz4Itg0)

Crééons un magnifique cube sur un projet Git en ligne pour le package manager :)
...
- Importez le Git de votre voisin dans le package manager en "Git URL" à votre project NotreBeauCube
...
- J'ajouterai tous vos projets et générerai un manifest avec les 13 boîtes à outils de cube.
  ...
  - Example avec [Magic Door sur google sheet](https://docs.google.com/spreadsheets/d/1ix5-vepfv-0SybpaODpU39KDhYOog2d64DxLUBR03CU/edit?gid=0#gid=0)
- Copier/Coller la scène du package "Mon Beau Cube Tag Script" dans votre projet
- Ouvrez la scène et jouez là.
- À l'écran, devraient être affichés tous vos cubes.
  

Note : Nous n'allons pas voir les asset bundles et les addressables, mais ceux-ci utilisent cette dernière technique et permettent d'alimenter un jeu sur le store sans "refaire" l'application. [Youtube Search](https://www.youtube.com/results?search_query=asset+bundle+uity)
...
Tutorial: [Part 6: Notre cube en XR sur Meta Quest 2,3](https://www.youtube.com/watch?v=N9jj6Y9kDaQ)
