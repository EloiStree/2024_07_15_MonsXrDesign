...
- Définissez les 6 points essentiels d'un pitch
  ...
  - > |> Integer Games
  - Votre cible
  - > |>  Developpeur that player to identify in the game without exposing their private key or API in app.
  - La problématique que vous résolvez
  - > |>  Il est très compliqué pour un développeur "classique" de faire un jeu Ethereum sans exposer la clé privé ou insérer un API.
  - Ce qui vous rend unique pour la résoudre
  - > |> I don't have Web3 skills in a world where all tools of Ethereum are for web-developer
