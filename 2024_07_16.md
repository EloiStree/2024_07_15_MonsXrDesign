...
# Exercice Bonus: Sauver un projet Unity de manière traditionnellement

Créé un git à la racine du projet Unity et utiliser un Git Ignore pour ignorer les "fichiers temporaires"
- Créé un projet Unity3D et préparé le en "version initial".
- Créé un répertoire sur git sur GitHub
- Clone le répertoire sur votre ordinateur (via GitHub Desktop ou `git clone`)
- Afficher les extensions de fichier et les dossiers cachés
- Bouger le dossier `ReadMe.md` et le `.git/` à côté du dossier asset de votre projet.
- Mettre à jour votre projet sur le server (`Add, Commit, Pull, Push`)
- Péparez votre téléphone pour la double authentification
- Inviter vos collèges à travailler sur le projet
